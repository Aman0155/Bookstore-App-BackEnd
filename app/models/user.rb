class User < ApplicationRecord
  has_secure_password
  validates :name, presence: true, format: { with: /\A[A-Z][a-zA-Z]{2,}\z/, message: "must start with a capital letter, be at least 3 characters long, and contain no digits or any special characters" }
